...
var headers = {
    ...
    'Authorization': 'Basic Njg5YmVkODEtN2VlYi00YmUyLTlhNWMtNjlmNzQzYzFmZTI1OjJ3cWhSVk5xQkNydQ=='
};

var options = {
    url: 'https://watson-api-explorer.mybluemix.net/retrieve-and-rank/api/v1/rankers/7ff701x33-rank-692',
    headers: headers
};
